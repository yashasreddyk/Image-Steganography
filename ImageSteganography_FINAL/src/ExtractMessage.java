...
{
    JButton open = new JButton("Open"), decode = new JButton("Extract Message"), reset = new JButton("Reset"), exit = new JButton("Exit");
    ...
    {
        super("Extract message from the Stego Image");
    ...
    private void assembleInterface() 
    {
        ...
        p.setBorder(BorderFactory.createTitledBorder("Extracted Message"));
